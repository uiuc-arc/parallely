...
func func_0() {
	...
	var DynMap [4118]diesel.ProbInterval
	...
	for __temp_2 := 0; __temp_2 < N; __temp_2++ {
		...
		temp6 = temp5 / 100.0
		maxpsd = diesel.DynCondFloat32GeqFloat32(temp6, maxpsd, DynMap[:], 4109, 4115, temp6, maxpsd, 4109, 4115, 4115)
		maxindex = diesel.DynCondFloat32GeqInt(temp6, maxpsd, DynMap[:], 4109, 4115, di, maxindex, 4096, 4116, 4116)
		i = i + 1
	...
	fmt.Println(DynMap[4115], DynMap[4116])
