...
func func_0() {
	...
	for __temp_0 := 0; __temp_0 < 10; __temp_0++ {
		...
		if temp_bool_1 != 0 {
			DynMap[7].Reliability = DynMap[5].Reliability * DynMap[2].Reliability
		} else {
			DynMap[7].Reliability = DynMap[5].Reliability * DynMap[3].Reliability
		}
		iter = iter + 1
	}
		...
		for __temp_4 := 0; __temp_4 < 10; __temp_4++ {
			...
			for a < transform_length {
				...
				for b < N {
					...
					// DynMap[4099].Delta =  + DynMap[4110].Delta

					// DynMap[4099].Delta = math.Abs(float64(w_real))*DynMap[4101].Delta + math.Abs(float64(z_real))*DynMap[4097].Delta + DynMap[4101].Delta*DynMap[4097].Delta + math.Abs(float64(w_imag))*DynMap[4102].Delta + math.Abs(float64(z_imag))*DynMap[4098].Delta + DynMap[4102].Delta*DynMap[4098].Delta
					t_real = temp6 - temp7
					...
					DynMap[4109].Delta = DynMap[2048+_temp_index_5].Delta + math.Abs(float64(w_real))*DynMap[4101].Delta + math.Abs(float64(z_real))*DynMap[4097].Delta + DynMap[4101].Delta*DynMap[4097].Delta + math.Abs(float64(w_imag))*DynMap[4102].Delta + math.Abs(float64(z_imag))*DynMap[4098].Delta + DynMap[4102].Delta*DynMap[4098].Delta
					temp6 = temp1 - t_real
