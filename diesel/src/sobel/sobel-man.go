...
func func_0() {
  ...
  var output [10000]float64;
	...
	for _, q := range(Q) {
		diesel.SendDynFloat32Array(input32[:], 0, q, DynMap[:], 2);
	}
	for _, q := range(Q) {
		diesel.ReceiveDynFloat32Array(slice[:], 0, q, DynMap[:], 10002);
		i = 0;
...
func func_Q(tid int) {
  ...
  q := tid;
	...
	diesel.ReceiveDynFloat32Array(array[:], tid, 0, DynMap[:], 0);
	i = (q-1)*10;
	k = 0;
	for __temp_2 := 0; __temp_2 < 10; __temp_2++ {
		...
		if conditional != 0 {
			for __temp_3 := 0; __temp_3 < 98; __temp_3++ {
				...
				DynMap[11001] = DynMap[0 + _temp_index_1];
				_temp_index_2 := i*100+j-100;
				temp2=array[_temp_index_2];
				DynMap[11002] = DynMap[0 + _temp_index_2];
				_temp_index_3 := i*100+j-99;
				temp3=array[_temp_index_3];
				DynMap[11003] = DynMap[0 + _temp_index_3];
				_temp_index_4 := i*100+j+99;
				temp4=array[_temp_index_4];
				DynMap[11004] = DynMap[0 + _temp_index_4];
				_temp_index_5 := i*100+j+100;
				temp5=array[_temp_index_5];
				DynMap[11005] = DynMap[0 + _temp_index_5];
				_temp_index_6 := i*100+j+101;
				temp6=array[_temp_index_6];
				DynMap[11006] = DynMap[0 + _temp_index_6];
				temp7 = 2*temp2;
				DynMap[11007].Reliability = DynMap[11002].Reliability;
				DynMap[11007].Delta = 2 * DynMap[11002].Delta;
				temp8 = 2*temp5;
				DynMap[11008].Reliability = DynMap[11005].Reliability;
				DynMap[11008].Delta = 2 * DynMap[11005].Delta;
				point = temp1+temp7;
				DynMap[11000].Reliability = DynMap[11001].Reliability + DynMap[11007].Reliability - 1.0;
				DynMap[11000].Delta = DynMap[11001].Delta + DynMap[11007].Delta;
				point = point+temp3;
				DynMap[11000].Reliability = DynMap[11003].Reliability + DynMap[11000].Reliability - float32(1);
				DynMap[11000].Delta = DynMap[11003].Delta + DynMap[11000].Delta;
				point = point-temp4;
				DynMap[11000].Reliability = DynMap[11004].Reliability + DynMap[11000].Reliability - float32(1);
				DynMap[11000].Delta = DynMap[11004].Delta + DynMap[11000].Delta;
				point = point-temp8;
				DynMap[11000].Reliability = DynMap[11008].Reliability + DynMap[11000].Reliability - float32(1);
				DynMap[11000].Delta = DynMap[11008].Delta + DynMap[11000].Delta;
				point = point-temp6;
				DynMap[11000].Reliability = DynMap[11006].Reliability + DynMap[11000].Reliability - float32(1);
				DynMap[11000].Delta = DynMap[11006].Delta + DynMap[11000].Delta;
				_temp_index_7 := k;
	...
	diesel.SendDynFloat32Array(slice[:], tid, 0, DynMap[:], 10000);
