...
func func_0() {
  ...
  var DynMap [21003]diesel.ProbInterval;
...
var temp1 float64;
var temp2 float32;
DynMap[10000] = diesel.ProbInterval{1, 0};
var temp3 float32;
DynMap[10001] = diesel.ProbInterval{1, 0};
var input32 [10000]float32;
diesel.InitDynArray(10002, 10000, DynMap[:]);
var slice [1000]float32;
diesel.InitDynArray(20002, 1000, DynMap[:]);
var elem float64;
DynMap[21002] = diesel.ProbInterval{1, 0};
i = 0;
size = 10000;
perthread = 1000;
...
DynMap[10000].Reliability = 1;
 DynMap[10000].Delta = diesel.GetCastingError64to32(temp1, temp2);
_temp_index_2 := i;
...
for _, q := range(Q) {
 diesel.SendDynFloat32Array(input32[:], 0, q, DynMap[:], 10002);
 }
for _, q := range(Q) {
 diesel.ReceiveDynFloat32Array(slice[:], 0, q, DynMap[:], 20002);
i = 0;
...
func func_Q(tid int) {
  defer diesel.Wg.Done();
  var DynMap [22010]diesel.ProbInterval;
  var my_chan_index int;
  _ = my_chan_index;
  _ = DynMap;
  q := tid;
...
diesel.InitDynArray(11000, 10000, DynMap[:]);
var slice32 [1000]float32;
diesel.InitDynArray(21000, 1000, DynMap[:]);
var i int;
var j int;
var c1 int;
var c2 int;
...
var conditional int;
var point float64;
DynMap[22000] = diesel.ProbInterval{1, 0};
var temp1 float64;
DynMap[22001] = diesel.ProbInterval{1, 0};
var temp2 float64;
DynMap[22002] = diesel.ProbInterval{1, 0};
var temp3 float64;
DynMap[22003] = diesel.ProbInterval{1, 0};
var temp4 float64;
DynMap[22004] = diesel.ProbInterval{1, 0};
var temp5 float64;
DynMap[22005] = diesel.ProbInterval{1, 0};
var temp6 float64;
DynMap[22006] = diesel.ProbInterval{1, 0};
var temp7 float64;
DynMap[22007] = diesel.ProbInterval{1, 0};
var temp8 float64;
DynMap[22008] = diesel.ProbInterval{1, 0};
var temp32 float32;
DynMap[22009] = diesel.ProbInterval{1, 0};
diesel.ReceiveDynFloat32Array(array32[:], tid, 0, DynMap[:], 11000);
i = 0;
...
for __temp_3 := 0; __temp_3 < c1; __temp_3++ {
 j = 1;
cond1 = diesel.ConvBool(i<99);
cond2 = diesel.ConvBool(i>0);
conditional = diesel.ConvBool(cond1==1 && cond2==1);
if conditional != 0 {
...
DynMap[22009].Reliability = DynMap[22001].Reliability;
 DynMap[22009].Delta = diesel.GetCastingError64to32(temp1, temp32);
_temp_index_13 := i;
slice32[_temp_index_13]=temp32;
DynMap[21000 + _temp_index_13] = DynMap[22009];
i = i+1;
 }
diesel.SendDynFloat32Array(slice32[:], tid, 0, DynMap[:], 21000);
