...
# Compile
commstr = """python ../../../parser/crosscompiler-diesel-acc.py -f sobel.par -t __basic_go.txt -o sobel.go"""
...
# Compile
commstr = """python ../../../parser/crosscompiler-diesel-acc.py -f sobel.par -t __basic_go.txt -o sobel.go -dyn"""
result_test = subprocess.check_output(commstr, shell=True)
print result_test
...
print "Running with dynamic tracking"
# Compile
commstr = """python ../../../parser/crosscompiler-diesel-acc.py -f sobel.par -t __basic_go.txt -o sobel-opt.go -dyn -a"""
result_test = subprocess.check_output(commstr, shell=True)
print result_test
