...
# Compile
commstr = """python2 ../../../parser/crosscompiler-diesel-dist.py -f scale.par -tm __basic_go_main.txt -tw __basic_go_worker.txt -i -o pg.go """
...
commstr = """python2 ../../../parser/crosscompiler-diesel-dist.py -f scale.par -tm __basic_go_main.txt -tw __basic_go_worker.txt -i -o pg.go -dyn"""
...
commstr = """python2 ../../../parser/crosscompiler-diesel-dist.py -f scale.par -tm __basic_go_main.txt -tw __basic_go_worker.txt -i -o pg.go -dyn -a"""
