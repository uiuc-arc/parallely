...
# Compile
commstr = """python ../../../parser/crosscompiler-diesel-acc.py -f mm-seq.par -t __basic_go.txt -o mm.go -i"""
...
commstr = """python ../../../parser/crosscompiler-diesel-acc.py -f mm-seq.par -t __basic_go.txt -o mm.go -dyn -i"""
...
# commstr = """python ../../../parser/crosscompiler-diesel.py -f mm.par -t __basic_go.txt -o mm.go -dyn -a"""
...
for i in range(numsamples):
    print "Running Iteration : ", i
    result_test = subprocess.check_output("go run mm-seq-man.go", shell=True)
