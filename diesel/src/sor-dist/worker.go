...
DynMap[21001] = dieseldistacc.GetCastingError64to32(tempDF64, tempDF32);
_temp_index_2 := idx0;
...
DynMap[22004] = DynMap[22002] + DynMap[22003];
...
DynMap[22003] = DynMap[22004] + DynMap[22002];
...
DynMap[22002] = DynMap[22003] + DynMap[22004];
...
DynMap[22004] = DynMap[22002] + DynMap[22003];
tempDF2 = tempDF0+tempDF1;
DynMap[22002] =  DynMap[22004] / math.Abs(5.0);
tempDF0 = tempDF2/5.0;
...
tempDF32 = float32(tempDF64);
DynMap[22001] = dieseldistacc.GetCastingError64to32(tempDF64, tempDF32);
_temp_index_16 := idx0;
