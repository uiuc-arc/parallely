...
if temp_bool_7 != 0 {DynMap[5146].Reliability  = DynMap[5147].Reliability * DynMap[5153].Reliability} else { DynMap[5146].Reliability = DynMap[5147].Reliability * DynMap[5146].Reliability};
k = k+1;
 }
_temp_index_8 := i;
