...
for inputgraph in inputsets:
    ...
    template_str = open("bfs.template", 'r').readlines()
    ...
    commstr = """python ../../../parser/crosscompiler-diesel.py -f __temp_gen.par -t __temp_gen.txt -o bfs.go; go build -tags instrument"""
    ...
    commstr = """python ../../../parser/crosscompiler-diesel.py -f __temp_gen.par -t __temp_gen.txt -o bfs.go; go build"""
    result_test = subprocess.check_output(commstr, shell=True)
    print result_test
    ...
    commstr = """python ../../../parser/crosscompiler-diesel.py -f __temp_gen.par -t __temp_gen.txt -o bfs.go -dyn; go build -tags instrument"""
    result_test = subprocess.check_output(commstr, shell=True)
    print result_test
    result_test = subprocess.check_output("./bfs-gen", shell=True)
    print result_test
    ...
    commstr = """python ../../../parser/crosscompiler-diesel.py -f __temp_gen.par -t __temp_gen.txt -o bfs.go -dyn; go build"""
    result_test = subprocess.check_output(commstr, shell=True)
    print result_test
    ...
    commstr = """python ../../../parser/crosscompiler-diesel.py -f __temp_gen.par -t __temp_gen.txt -o bfs.go -dyn -a; go build -tags instrument"""
    result_test = subprocess.check_output(commstr, shell=True)
    print result_test
    result_test = subprocess.check_output("./bfs-gen", shell=True)
    print result_test
    ...
    commstr = """python ../../../parser/crosscompiler-diesel.py -f __temp_gen.par -t __temp_gen.txt -o bfs.go -dyn -a; go build"""
    result_test = subprocess.check_output(commstr, shell=True)
    print result_test
