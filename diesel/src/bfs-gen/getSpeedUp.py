...
# Compile
commstr = """python2 ../../../parser/crosscompiler-diesel.py -f bfs.par -t __basic_go.txt -o bfs.go; go build"""
...
commstr = """python2 ../../../parser/crosscompiler-diesel.py -f bfs.par -t __basic_go.txt -o bfs.go -dyn; go build"""
