...
for inputgraph in inputsets:
    ...
    commstr = """python2 ../../../parser/crosscompiler-diesel-dist.py -f __temp_gen.par -tm __temp_main.txt -tw __temp_worker.txt -o bfs.go -i -rel"""
    ...
    commstr = """python2 ../../../parser/crosscompiler-diesel-dist.py -f __temp_gen.par -tm __temp_main.txt -tw __temp_worker.txt -o bfs.go -i -dyn -rel"""
    result_test = subprocess.check_output(commstr, shell=True)
    print(result_test)
    ...
    commstr = """python2 ../../../parser/crosscompiler-diesel-dist.py -f __temp_gen.par -tm __temp_main.txt -tw __temp_worker.txt -o bfs.go -i -dyn -a -rel"""
    result_test = subprocess.check_output(commstr, shell=True)
    print(result_test)
