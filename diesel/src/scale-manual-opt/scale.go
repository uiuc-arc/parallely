...
func func_0() {
  ...
  var s_height int;
	...
	fmt.Println("Spec checkarray(outImage, 0.99): ", diesel.CheckArray(524288, 0.99, 4194304, DynMap[:]));
  ...
  q := tid;
	...
	for __temp_2 := 0; __temp_2 < myrows; __temp_2++ {
		...
		for __temp_3 := 0; __temp_3 < d_width; __temp_3++ {
			...
			// DynMap[524288].Reliability = DynMap[524288].Reliability * 0.9999;
	...
	temp_val := diesel.ProbInterval{0.9999*0.9999*0.9999*0.9999, 0}
