...
commstr = """rm -f dynmap*; python ../../../parser/crosscompiler-diesel.py -f pagerank.par -t __basic_go.txt -o pagerank.go -dyn -i; go build"""

result_test = subprocess.check_output(commstr, shell=True)
print result_test

result_test = subprocess.check_output("./pagerank-sensitivity", shell=True)
print result_test
before_opt = getRelDegredation()

print "Running with array optimization"

commstr = """rm -f dynmap*; python ../../../parser/crosscompiler-diesel.py -f pagerank.par -t __basic_go.txt -o pagerank.go -dyn -i -a; go build"""
