...
# Compile
commstr = """python ../../../parser/crosscompiler-diesel.py -f combined.par -t template.txt -o out.go -i"""
...
commstr = """python ../../../parser/crosscompiler-diesel.py -f combined.par -t template.txt -o out.go -dyn -i"""
