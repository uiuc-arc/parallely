...
str_single_thread = '''func {}() {{
  ...
  var DynMap [{}]dieseldistacc.ProbInterval;
...
str_probchoiceIntFlag = "{} = dieseldistacc.RandchoiceFlag(float32({}), {}, {}, &__flag_{});\n"
str_probchoiceInt = "{} = dieseldistacc.Randchoice(float32({}), {}, {});\n"

dyn_rec_str = '''my_chan_index = {0} * dieseldistacc.Numprocesses + {1};
__temp_rec_val_{3} := dieseldistacc.GetDynValue(my_chan_index);
DynMap[{2}] = __temp_rec_val_{3};
'''

ch_str = '''
fmt.Println("----------------------------");\n
fmt.Println("Spec checkarray({3}, {1}): ", dieseldistacc.CheckArray({0}, {1}, {2}, DynMap[:]));\n
fmt.Println("----------------------------");\n
'''

# dyn_pchoice_str = '''DynMap[{}].Reliability = dieseldistacc.Max(0.0, {} - float32({})) * {};
# '''

# dyn_assign_str = '''DynMap[{}].Reliability = {} - {}.0;
# '''

dyn_precise = '''DynMap[{}] = dieseldistacc.ProbInterval{{0}};\n'''
...
class Translator(ParallelyVisitor):
    ...
    def visitCondsend(self, ctx):
        cond_send_str = {
            ("int", 0): "dieseldistacc.Condsend({}, {}, {}, {});\n",
            ("int32", 0): "dieseldistacc.CondsendInt32({}, {}, {}, {});\n",
            ("int64", 0): "dieseldistacc.CondsendInt64({}, {}, {}, {});\n",
            ("float32", 0): "dieseldistacc.CondsendFloat32({}, {}, {}, {});\n",
            ("float64", 0): "dieseldistacc.CondsendFloat64({}, {}, {}, {});\n",
            ("int", 1): "dieseldistacc.CondsendIntArray({}, {}[:], {}, {});\n",
            ("int", 1): "dieseldistacc.CondsendIntArray({}, {}[:], {}, {});\n",
        }
    ...
    def visitSend(self, ctx):
        send_str = {
            ("int", 0): "dieseldistacc.SendInt({}, {}, {});\n",
            ("int32", 0): "dieseldistacc.SendInt32({}, {}, {});\n",
            ("int64", 0): "dieseldistacc.SendInt64({}, {}, {});\n",
            ("float32", 0): "dieseldistacc.SendFloat32({}, {}, {});\n",
            ("float64", 0): "dieseldistacc.SendFloat64({}, {}, {});\n",
            ("int", 1): "dieseldistacc.SendIntArray({}[:], {}, {});\n",
            ("int32", 1): "dieseldistacc.SendInt32Array({}[:], {}, {});\n",
            ("int64", 1): "dieseldistacc.SendInt64Array({}[:], {}, {});\n",
            ("float32", 1): "dieseldistacc.SendFloat32Array({}[:], {}, {});\n",
            ("float64", 1): "dieseldistacc.SendFloat64Array({}[:], {}, {});\n"
        }

        dyn_send_str = {
            ("int", 0): "dieseldistacc.SendDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieseldistacc.SendDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 0): "dieseldistacc.SendDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieseldistacc.SendDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieseldistacc.SendDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 1): "dieseldistacc.SendDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }
    ...
    def visitReceive(self, ctx):
        rec_str = {
            ("int", 0): "dieseldistacc.ReceiveInt(&{}, {}, {});\n",
            ("int32", 0): "dieseldistacc.ReceiveInt32(&{}, {}, {});\n",
            ("int64", 0): "dieseldistacc.ReceiveInt64(&{}, {}, {});\n",
            ("float32", 0): "dieseldistacc.ReceiveFloat32(&{}, {}, {});\n",
            ("float64", 0): "dieseldistacc.ReceiveFloat64(&{}, {}, {});\n",
            ("int", 1): "dieseldistacc.ReceiveIntArray({}[:], {}, {});\n",
            ("int32", 1): "dieseldistacc.ReceiveInt32Array({}[:], {}, {});\n",
            ("int64", 1): "dieseldistacc.ReceiveInt64Array({}[:], {}, {});\n",
            ("float32", 1): "dieseldistacc.ReceiveFloat32Array({}[:], {}, {});\n",
            ("float64", 1): "dieseldistacc.ReceiveFloat64Array({}[:], {}, {});\n"
        }

        dyn_rec_dict = {
            ("int", 0): "dieseldistacc.ReceiveDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieseldistacc.ReceiveDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 0): "dieseldistacc.ReceiveDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieseldistacc.ReceiveDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieseldistacc.ReceiveDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 1): "dieseldistacc.ReceiveDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }

        noisy_dyn_rec_dict = {
            ("int", 0): "dieseldistacc.NoisyReceiveDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieseldistacc.NoisyReceiveDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            # ("float32", 0): "dieseldistacc.NoisyReceiveDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieseldistacc.NoisyReceiveDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieseldistacc.NoisyReceiveDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            # ("float32", 1): "dieseldistacc.NoisyReceiveDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }
    ...
    def visitCondreceive(self, ctx):
        rec_str = {
            ("int", 0): "dieseldistacc.Condreceive(&{}, &{}, {}, {});\n",
            ("int32", 0): "dieseldistacc.CondreceiveInt32(&{}, &{}, {}, {});\n",
            ("int64", 0): "dieseldistacc.CondreceiveInt64(&{}, &{}, {}, {});\n",
            # ("float32", 0):
            # ("float64", 0):
            ("int", 1): "dieseldistacc.CondreceiveIntArray(&{}, {}[:], {}, {});\n",
            # ("int32", 1):
            # ("int64", 1):
            ("float32", 1): "dieseldistacc.CondreceiveFloat32(&{}, &{}, {}, {});\n",
            ("float64", 1): "dieseldistacc.CondreceiveFloat64(&{}, &{}, {}, {});\n"
        }
        senttype = self.getType(ctx.fulltype())
    ...
    #     rand_str = {
    #         ("int"): "{} = dieseldistacc.Randchoice(float32({}), {}, {});\n",
    #         ("float64"): "{} = dieseldistacc.RandchoiceFloat64(float32({}), {}, {});\n",
    #         # ("int32", 0): "dieseldistacc.CondreceiveInt32(&{}, &{}, {}, {});\n",
    #         # ("int64", 0): "dieseldistacc.CondreceiveInt64(&{}, &{}, {}, {});\n",
    #         # ("float32", 0):
    #         # ("float64", 0):
    ...
    def handleExpression(self, ctx):
        # print ctx.getText()
        convert_str = "dieseldistacc.ConvBool({})"
        ...
        if  isinstance(ctx, ParallelyParser.AndexpContext):
            convert_str = "dieseldistacc.ConvBool({}==1 && {}==1)".format(ctx.expression(0).getText(),
                                                                       ctx.expression(1).getText())
            return convert_str
    ...
    def visitDyncondassignmentgeq(self, ctx):
        convert_cond_str_list = {
            ("float32", "int"): "{} = dieseldistacc.DynCondFloat32GeqInt({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float64", "int"): "{} = dieseldistacc.DynCondFloat64GeqInt({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float32", "float32"): "{} = dieseldistacc.DynCondFloat32GeqFloat32({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float64", "float64"): "{} = dieseldistacc.DynCondFloat64GeqFloat64({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
        }
    ...
    def visitExpassignment(self, ctx):
        ...
        if (self.enableDynamic and var_str in self.arrays and
            ...
            if self.primitiveTMap[expr_str] == 'precise':
                dyn_c_str = "dieseldistacc.InitDynArray({}, {}, DynMap[:]);\n".format(self.varMap[var_str],
                                                                               self.arraySize[var_str])
            else:
                dyn_c_str = "dieseldistacc.CopyDynArray({}, {}, {}, DynMap[:]);\n".format(self.varMap[var_str],
        ...
        return  acc_str + assign_str.format(var_str, expr_str)
    ...
    def getAccuracyStr(self, ctx, var_str):
        ...
        # We need to fix this
            ...
            if len(var_list) == 0:
                return "DynMap[{0}] = dieseldistacc.ProbInterval{{0}};\n".format(self.varMap[var_str])
            if len(var_list) == 1:
    ...
    def visitArrayassignment(self, ctx):
        ...
        if self.enableDynamic and a_var in self.primitiveTMap and self.primitiveTMap[a_var] == 'dynamic':
            ...
            dyn_upd_map = "DynMap[{0} + _temp_index_{3}] = dieseldistacc.Max(0.0, {1} - float64({2}));\n"
            var_list = list(set(self.getVarList(ctx.expression()[1])))
            if len(var_list) == 0:
                dyn_str = "DynMap[{} + _temp_index_{}] = dieseldistacc.ProbInterval{{0}};\n".format(self.varMap[a_var], self.tempindexnum)
            elif len(var_list) == 1:
    ...
    def visitCast(self, ctx):
        ...
        if resultType[1] == "float64" and resultType[2] == 1:
            return "dieseldistacc.Cast32to64Array({}[:], {}[:]);\n".format(assignedvar,
                                                                    castedvar)
        if resultType[1] == "float32" and resultType[2] == 1:
            return "dieseldistacc.Cast64to32Array({}[:], {}[:]);\n".format(assignedvar,
                                                                    castedvar)
        # Regular cast
        ...
        if resultType[1] == "float32" and resultType[2] == 0:
            ...
            if self.enableDynamic:
                if castedvar in self.varMap:
                    d_str = "DynMap[{0}].Delta = dieseldistacc.GetCastingError64to32({1}, {2});\n"
    ...
    def visitTrack(self, ctx):
        ...
        if self.enableDynamic:
            updstr = "DynMap[{}] = dieseldistacc.ProbInterval{{{}}};\n".format(
                self.varMap[ctx.var(0).getText()],
                ctx.FLOAT().getText())
    ...
    def handleDec(self, decl):
        ...
        if isinstance(decl, ParallelyParser.ArraydeclarationContext):
            ...
            if self.enableDynamic and dectype[0] == "dynamic":
                ...
                d_str = ""
                if self.enableDynamic:
                    d_str = "dieseldistacc.InitDynArray({}, {}, DynMap[:]);\n".format(self.varMap[varname],
                                                                               decl.INT()[0])
        ...
        if isinstance(decl, ParallelyParser.DynarraydeclarationContext):
            ...
            if self.enableDynamic and dectype[0] == "dynamic":
                ...
                self.dynsize += 1
                print "Increasing dynamic size: ", self.dynsize
                d_init_str = "var {0} {1};\nDynMap[{2}] = dieseldistacc.ProbInterval{{0}};\n"
...
def main(program_str, outfile, filename, maintemplate, worktemplate, debug, dynamic, args):
    ...
    translator.translate(tree, threadcounter.processcount, threadcounter.processes, outfile, maintemplate, worktemplate)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-tm", dest="maintemplate",
                        help="File containing the template for main", required=True)
    parser.add_argument("-tw", dest="worktemplate",
                        help="File containing the template for worker", required=True)    
