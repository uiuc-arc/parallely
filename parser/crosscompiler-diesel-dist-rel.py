...
str_probchoiceIntFlag = "{} = dieseldistrel.RandchoiceFlag(float32({}), {}, {}, &__flag_{});\n"
str_probchoiceInt = "{} = dieseldistrel.Randchoice(float32({}), {}, {});\n"

dyn_rec_str = '''my_chan_index = {0} * dieseldistrel.Numprocesses + {1};
__temp_rec_val_{3} := dieseldistrel.GetDynValue(my_chan_index);
DynMap[{2}] = __temp_rec_val_{3};
'''

ch_str = '''
fmt.Println("----------------------------");\n
fmt.Println("Spec checkarray({3}, {1}): ", dieseldistrel.CheckArray({0}, {1}, {2}, DynMap[:]));\n
fmt.Println("----------------------------");\n
'''

dyn_pchoice_str = '''DynMap[{}] = dieseldistrel.Max(0.0, {} - float32({})) * {};
'''

dyn_assign_str = '''DynMap[{}] = {} - {}.0;
'''
...
class Translator(ParallelyVisitor):
    ...
    def visitCondsend(self, ctx):
        cond_send_str = {
            ("int", 0): "dieseldistrel.Condsend({}, {}, {}, {});\n",
            ("int32", 0): "dieseldistrel.CondsendInt32({}, {}, {}, {});\n",
            ("int64", 0): "dieseldistrel.CondsendInt64({}, {}, {}, {});\n",
            ("float32", 0): "dieseldistrel.CondsendFloat32({}, {}, {}, {});\n",
            ("float64", 0): "dieseldistrel.CondsendFloat64({}, {}, {}, {});\n",
            ("int", 1): "dieseldistrel.CondsendIntArray({}, {}[:], {}, {});\n",
            ("int", 1): "dieseldistrel.CondsendIntArray({}, {}[:], {}, {});\n",
        }
    ...
    def visitSend(self, ctx):
        send_str = {
            ("int", 0): "dieseldistrel.SendInt({}, {}, {});\n",
            ("int32", 0): "dieseldistrel.SendInt32({}, {}, {});\n",
            ("int64", 0): "dieseldistrel.SendInt64({}, {}, {});\n",
            ("float32", 0): "dieseldistrel.SendFloat32({}, {}, {});\n",
            ("float64", 0): "dieseldistrel.SendFloat64({}, {}, {});\n",
            ("int", 1): "dieseldistrel.SendIntArray({}[:], {}, {});\n",
            ("int32", 1): "dieseldistrel.SendInt32Array({}[:], {}, {});\n",
            ("int64", 1): "dieseldistrel.SendInt64Array({}[:], {}, {});\n",
            ("float32", 1): "dieseldistrel.SendFloat32Array({}[:], {}, {});\n",
            ("float64", 1): "dieseldistrel.SendFloat64Array({}[:], {}, {});\n"
        }

        dyn_send_str = {
            ("int", 0): "dieseldistrel.SendDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieseldistrel.SendDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 0): "dieseldistrel.SendDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieseldistrel.SendDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieseldistrel.SendDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 1): "dieseldistrel.SendDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }
    ...
    def visitReceive(self, ctx):
        rec_str = {
            ("int", 0): "dieseldistrel.ReceiveInt(&{}, {}, {});\n",
            ("int32", 0): "dieseldistrel.ReceiveInt32(&{}, {}, {});\n",
            ("int64", 0): "dieseldistrel.ReceiveInt64(&{}, {}, {});\n",
            ("float32", 0): "dieseldistrel.ReceiveFloat32(&{}, {}, {});\n",
            ("float64", 0): "dieseldistrel.ReceiveFloat64(&{}, {}, {});\n",
            ("int", 1): "dieseldistrel.ReceiveIntArray({}[:], {}, {});\n",
            ("int32", 1): "dieseldistrel.ReceiveInt32Array({}[:], {}, {});\n",
            ("int64", 1): "dieseldistrel.ReceiveInt64Array({}[:], {}, {});\n",
            ("float32", 1): "dieseldistrel.ReceiveFloat32Array({}[:], {}, {});\n",
            ("float64", 1): "dieseldistrel.ReceiveFloat64Array({}[:], {}, {});\n"
        }

        dyn_rec_dict = {
            ("int", 0): "dieseldistrel.ReceiveDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieseldistrel.ReceiveDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 0): "dieseldistrel.ReceiveDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieseldistrel.ReceiveDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieseldistrel.ReceiveDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 1): "dieseldistrel.ReceiveDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }

        noisy_dyn_rec_dict = {
            ("int", 0): "dieseldistrel.NoisyReceiveDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieseldistrel.NoisyReceiveDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            # ("float32", 0): "dieseldistrel.NoisyReceiveDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieseldistrel.NoisyReceiveDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieseldistrel.NoisyReceiveDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            # ("float32", 1): "dieseldistrel.NoisyReceiveDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }
    ...
    def visitCondreceive(self, ctx):
        rec_str = {
            ("int", 0): "dieseldistrel.Condreceive(&{}, &{}, {}, {});\n",
            ("int32", 0): "dieseldistrel.CondreceiveInt32(&{}, &{}, {}, {});\n",
            ("int64", 0): "dieseldistrel.CondreceiveInt64(&{}, &{}, {}, {});\n",
            # ("float32", 0):
            # ("float64", 0):
            ("int", 1): "dieseldistrel.CondreceiveIntArray(&{}, {}[:], {}, {});\n",
            # ("int32", 1):
            # ("int64", 1):
            ("float32", 1): "dieseldistrel.CondreceiveFloat32(&{}, &{}, {}, {});\n",
            ("float64", 1): "dieseldistrel.CondreceiveFloat64(&{}, &{}, {}, {});\n"
        }
        senttype = self.getType(ctx.fulltype())
    ...
    def visitProbassignment(self, ctx):
        rand_str = {
            ("int"): "{} = dieseldistrel.Randchoice(float32({}), {}, {});\n",
            ("float64"): "{} = dieseldistrel.RandchoiceFloat64(float32({}), {}, {});\n",
            # ("int32", 0): "dieseldistrel.CondreceiveInt32(&{}, &{}, {}, {});\n",
            # ("int64", 0): "dieseldistrel.CondreceiveInt64(&{}, &{}, {}, {});\n",
            # ("float32", 0):
            # ("float64", 0):
    ...
    def handleExpression(self, ctx):
        # print ctx.getText()
        convert_str = "dieseldistrel.ConvBool({})"
        ...
        if  isinstance(ctx, ParallelyParser.AndexpContext):
            convert_str = "dieseldistrel.ConvBool({}==1 && {}==1)".format(ctx.expression(0).getText(),
                                                                       ctx.expression(1).getText())
            return convert_str
    ...
    def visitDyncondassignmentgeq(self, ctx):
        convert_cond_str_list = {
            ("float32", "int"): "{} = dieseldistrel.DynCondFloat32GeqInt({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float64", "int"): "{} = dieseldistrel.DynCondFloat64GeqInt({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float32", "float32"): "{} = dieseldistrel.DynCondFloat32GeqFloat32({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float64", "float64"): "{} = dieseldistrel.DynCondFloat64GeqFloat64({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
        }
    ...
    def visitCondassignment(self, ctx):
        ...
        t_d_str = '''if temp_bool_{0} != 0 {{DynMap[{1}]  = DynMap[{2}] * DynMap[{3}]}} else {{ DynMap[{1}] = DynMap[{2}] * DynMap[{4}]}};\n'''
    ...
    def visitExpassignment(self, ctx):
        ...
        if (self.enableDynamic and var_str in self.arrays and
            ...
            if self.primitiveTMap[expr_str] == 'precise':
                dyn_c_str = "dieseldistrel.InitDynArray({}, {}, DynMap[:]);\n".format(self.varMap[var_str],
                                                                               self.arraySize[var_str])
            else:
                dyn_c_str = "dieseldistrel.CopyDynArray({}, {}, {}, DynMap[:]);\n".format(self.varMap[var_str],
    ...
    #         if len(var_list) == 0:
    #             return "DynMap[{0}] = dieseldistrel.ProbInterval{{1, 0}};\n".format(self.varMap[var_str])
    #         if len(var_list) == 1:
    ...
    def visitArrayassignment(self, ctx):
        ...
        if self.enableDynamic and a_var in self.primitiveTMap and self.primitiveTMap[a_var] == 'dynamic':
            ...
            dyn_upd_map = "DynMap[{0} + _temp_index_{3}] = dieseldistrel.Max(0.0, {1} - float64({2}));\n"
            var_list = list(set(self.getVarList(ctx.expression()[1])))
            if len(var_list) == 0:
                dyn_str = "DynMap[{} + _temp_index_{}] = float32(1.0);\n".format(self.varMap[a_var], self.tempindexnum)
            elif len(var_list) == 1:
    ...
    #         return "dieseldistrel.Cast32to64Array({}[:], {}[:]);\n".format(assignedvar,
    #                                                                 castedvar)
    #     if resultType[1] == "float32" and resultType[2] == 1:
    #         return "dieseldistrel.Cast64to32Array({}[:], {}[:]);\n".format(assignedvar,
    #                                                                 castedvar)
    #     # Regular cast
    ...
    def handleDec(self, decl):
        ...
        if isinstance(decl, ParallelyParser.ArraydeclarationContext):
            ...
            if self.enableDynamic and dectype[0] == "dynamic":
                ...
                d_str = ""
                if self.enableDynamic:
                    d_str = "dieseldistrel.InitDynArray({}, {}, DynMap[:]);\n".format(self.varMap[varname],
                                                                               decl.INT()[0])
