...
str_probchoiceIntFlag = "{} = dieselacc.RandchoiceFlag(float32({}), {}, {}, &__flag_{});\n"
str_probchoiceInt = "{} = dieselacc.Randchoice(float32({}), {}, {});\n"

dyn_rec_str = '''my_chan_index = {0} * dieselacc.Numprocesses + {1};
__temp_rec_val_{3} := <- dieselacc.DynamicChannelMap[my_chan_index];
DynMap[{2}] = __temp_rec_val_{3};
'''

ch_str = '''
fmt.Println("----------------------------");\n
fmt.Println("Spec checkarray({3}, {1}): ", dieselacc.CheckArray({0}, {1}, {2}, DynMap[:]));\n
fmt.Println("----------------------------");\n
'''
...
class AccSpecRenamer(ParallelyListener):
    ...
    def enterLocalvariable(self, ctx):
        ...
        # if isinstance(ctx, ParallelyLexer.GLOBALVAR):
        #     return ctx.getText()
        new_name = "DynMap[{}]".format(self.varmap[self.specvarmap[ctx.getText()]])
        print ctx.getText(), new_name
            # self.rewriter.insertBeforeIndex(ctx.start.tokenIndex, new_name)
            # self.rewriter.insertBeforeToken(ctx.start, new_name)
        self.rewriter.insertAfterToken(ctx.stop, new_name)
...
class Translator(ParallelyVisitor):
    ...
    def visitCondsend(self, ctx):
        cond_send_str = {
            ("int", 0): "dieselacc.Condsend({}, {}, {}, {});\n",
            ("int32", 0): "dieselacc.CondsendInt32({}, {}, {}, {});\n",
            ("int64", 0): "dieselacc.CondsendInt64({}, {}, {}, {});\n",
            ("float32", 0): "dieselacc.CondsendFloat32({}, {}, {}, {});\n",
            ("float64", 0): "dieselacc.CondsendFloat64({}, {}, {}, {});\n",
            ("int", 1): "dieselacc.CondsendIntArray({}, {}[:], {}, {});\n",
            ("int", 1): "dieselacc.CondsendIntArray({}, {}[:], {}, {});\n",
        }
    ...
    def visitSend(self, ctx):
        send_str = {
            ("int", 0): "dieselacc.SendInt({}, {}, {});\n",
            ("int32", 0): "dieselacc.SendInt32({}, {}, {});\n",
            ("int64", 0): "dieselacc.SendInt64({}, {}, {});\n",
            ("float32", 0): "dieselacc.SendFloat32({}, {}, {});\n",
            ("float64", 0): "dieselacc.SendFloat64({}, {}, {});\n",
            ("int", 1): "dieselacc.SendIntArray({}[:], {}, {});\n",
            ("int32", 1): "dieselacc.SendInt32Array({}[:], {}, {});\n",
            ("int64", 1): "dieselacc.SendInt64Array({}[:], {}, {});\n",
            ("float32", 1): "dieselacc.SendFloat32Array({}[:], {}, {});\n",
            ("float64", 1): "dieselacc.SendFloat64Array({}[:], {}, {});\n"
        }

        dyn_send_str = {
            ("int", 0): "dieselacc.SendDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieselacc.SendDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 0): "dieselacc.SendDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieselacc.SendDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieselacc.SendDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 1): "dieselacc.SendDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }
    ...
    def visitReceive(self, ctx):
        rec_str = {
            ("int", 0): "dieselacc.ReceiveInt(&{}, {}, {});\n",
            ("int32", 0): "dieselacc.ReceiveInt32(&{}, {}, {});\n",
            ("int64", 0): "dieselacc.ReceiveInt64(&{}, {}, {});\n",
            ("float32", 0): "dieselacc.ReceiveFloat32(&{}, {}, {});\n",
            ("float64", 0): "dieselacc.ReceiveFloat64(&{}, {}, {});\n",
            ("int", 1): "dieselacc.ReceiveIntArray({}[:], {}, {});\n",
            ("int32", 1): "dieselacc.ReceiveInt32Array({}[:], {}, {});\n",
            ("int64", 1): "dieselacc.ReceiveInt64Array({}[:], {}, {});\n",
            ("float32", 1): "dieselacc.ReceiveFloat32Array({}[:], {}, {});\n",
            ("float64", 1): "dieselacc.ReceiveFloat64Array({}[:], {}, {});\n"
        }

        dyn_rec_dict = {
            ("int", 0): "dieselacc.ReceiveDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieselacc.ReceiveDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 0): "dieselacc.ReceiveDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieselacc.ReceiveDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieselacc.ReceiveDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float32", 1): "dieselacc.ReceiveDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }

        noisy_dyn_rec_dict = {
            ("int", 0): "dieselacc.NoisyReceiveDynIntArray({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 0): "dieselacc.NoisyReceiveDynFloat64Array({}[:], {}, {}, DynMap[:], {});\n",
            # ("float32", 0): "dieselacc.NoisyReceiveDynFloat32Array({}[:], {}, {}, DynMap[:], {});\n",
            ("int", 1): "dieselacc.NoisyReceiveDynIntArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            ("float64", 1): "dieselacc.NoisyReceiveDynFloat64ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
            # ("float32", 1): "dieselacc.NoisyReceiveDynFloat32ArrayO1({}[:], {}, {}, DynMap[:], {});\n",
        }
    ...
    def visitCondreceive(self, ctx):
        rec_str = {
            ("int", 0): "dieselacc.Condreceive(&{}, &{}, {}, {});\n",
            ("int32", 0): "dieselacc.CondreceiveInt32(&{}, &{}, {}, {});\n",
            ("int64", 0): "dieselacc.CondreceiveInt64(&{}, &{}, {}, {});\n",
            # ("float32", 0):
            # ("float64", 0):
            ("int", 1): "dieselacc.CondreceiveIntArray(&{}, {}[:], {}, {});\n",
            # ("int32", 1):
            # ("int64", 1):
            ("float32", 1): "dieselacc.CondreceiveFloat32(&{}, &{}, {}, {});\n",
            ("float64", 1): "dieselacc.CondreceiveFloat64(&{}, &{}, {}, {});\n"
        }
        senttype = self.getType(ctx.fulltype())
    ...
    #     rand_str = {
    #         ("int"): "{} = dieselacc.Randchoice(float32({}), {}, {});\n",
    #         ("float64"): "{} = dieselacc.RandchoiceFloat64(float32({}), {}, {});\n",
    #         # ("int32", 0): "dieselacc.CondreceiveInt32(&{}, &{}, {}, {});\n",
    #         # ("int64", 0): "dieselacc.CondreceiveInt64(&{}, &{}, {}, {});\n",
    #         # ("float32", 0):
    #         # ("float64", 0):
    ...
    def handleExpression(self, ctx):
        convert_str = "dieselacc.ConvBool({})"
        ...
        if  isinstance(ctx, ParallelyParser.AndexpContext):
            convert_str = "dieselacc.ConvBool({}==1 && {}==1)".format(ctx.expression(0).getText(),
                                                                       ctx.expression(1).getText())
            return convert_str
    ...
    def visitDyncondassignmentgeq(self, ctx):
        convert_cond_str_list = {
            ("float32", "int"): "{} = dieselacc.DynCondFloat32GeqInt({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float64", "int"): "{} = dieselacc.DynCondFloat64GeqInt({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",            
            ("float32", "float32"): "{} = dieselacc.DynCondFloat32GeqFloat32({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
            ("float64", "float64"): "{} = dieselacc.DynCondFloat64GeqFloat64({}, {}, DynMap[:], {}, {}, {}, {}, {}, {}, {});\n",
        }
    ...
    def visitExpassignment(self, ctx):
        ...
        if (self.enableDynamic and var_str in self.arrays and
            ...
            if self.primitiveTMap[expr_str] == 'precise':
                dyn_c_str = "dieselacc.InitDynArray({}, {}, DynMap[:]);\n".format(self.varMap[var_str],
                                                                               self.arraySize[var_str])
            else:
                dyn_c_str = "dieselacc.CopyDynArray({}, {}, {}, DynMap[:]);\n".format(self.varMap[var_str],
        ...
        # We need to fix this
            ...
            if len(var_list) == 1:
                if (isinstance(ctx.expression(0), ParallelyParser.FliteralContext) or
                    ...
                    upd_str = "DynMap[{0}] =  DynMap[{2}] / math.Abs(float64({1}));\n"
                    return upd_str.format(self.varMap[var_str],
                                          ctx.expression(1).getText(), self.varMap[var_list[0]])
                ...
                upd_str = "DynMap[{0}] = math.Abs(float64({1})) * DynMap[{2}] + math.Abs(float64({3})) * DynMap[{4}] / (math.Abs(float64({3})) * (math.Abs(float64({1}))-DynMap[{4}]));\n"
                return upd_str.format(self.varMap[var_str], var_list[0], self.varMap[var_list[0]],
                                      var_list[1], self.varMap[var_list[1]])
    ...
    def visitArrayassignment(self, ctx):
        ...
        if self.enableDynamic and a_var in self.primitiveTMap and self.primitiveTMap[a_var] == 'dynamic':
            ...
            dyn_upd_map = "DynMap[{0} + _temp_index_{3}] = dieselacc.Max(0.0, {1} - float64({2}));\n"
    ...
    def visitCast(self, ctx):
        ...
        if resultType[1] == "float64" and resultType[2] == 1:
            return "dieselacc.Cast32to64Array({}[:], {}[:]);\n".format(assignedvar,
                                                                    castedvar)
        if resultType[1] == "float32" and resultType[2] == 1:
            return "dieselacc.Cast64to32Array({}[:], {}[:]);\n".format(assignedvar,
                                                                    castedvar)
        # Regular cast
        ...
        if resultType[1] == "float32" and resultType[2] == 0:
            ...
            if self.enableDynamic:
                if castedvar in self.varMap:
                    d_str = "DynMap[{0}] = dieselacc.GetCastingError64to32({1}, {2});\n"
    ...
    def visitSpeccheck(self, ctx):
        ...
        statement = "if {1}<DynMap[{0}] {{panic(\"check failed\")}}\n"
    ...
    def handleDec(self, decl):
        ...
        if isinstance(decl, ParallelyParser.ArraydeclarationContext):
            ...
            if self.enableDynamic and dectype[0] == "dynamic":
                ...
                d_str = ""
                if self.enableDynamic:
                    d_str = "dieselacc.InitDynArray({}, {}, DynMap[:]);\n".format(self.varMap[varname],
                                                                               decl.INT()[0])
